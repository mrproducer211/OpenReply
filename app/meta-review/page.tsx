...
export const metadata: Metadata = {
  title: "Meta App Review Support - Claude OpenAI",
  description:
    "Meta App Review notes for Claude OpenAI's Instagram private reply workflow.",
};
...
export default function MetaReviewPage() {
  return (
    <LegalShell
      ...
      description="Claude OpenAI is designed for Instagram professional accounts that want to send private replies after keyword comments on their own posts or reels. Built for the people, by the people."
    ...
    >
      <section>
        ...
        <p className="mt-3">
          ...
          reel, and receives a webhook when someone comments. Claude OpenAI queues
